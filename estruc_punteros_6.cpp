...
#include <stdlib.h>
#include <string.h>
/*defina estruc que sirva para representar a una persona .
la estruc debe contener dos campos el nombre de la persona y un
valor de tipo logico que indica si la persona tiene algun tipo de discapacidad
realice un progrma que dado un vector de persons rellene dos nuevos vectores
uno que contenga las personas que no tiene ninguna discapacidad
